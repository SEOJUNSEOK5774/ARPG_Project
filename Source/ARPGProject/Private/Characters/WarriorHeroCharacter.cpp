...
AWarriorHeroCharacter::AWarriorHeroCharacter()
{
	...
	//카메라와 카메라 붐은 일체형으로 서로 회전하지 않기 위해 부착
...
void AWarriorHeroCharacter::PossessedBy(AController* NewController)
{
	...
	{
		if (UMyDataAsset_StartUpBase* LoadedData = CharacterStartUpData.LoadSynchronous())
		{
			LoadedData->GiveToAbilitiesSystemComponent(WarriorAbilitySystemComponent);
		}
	}
...
void AWarriorHeroCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	WarriorInputComponent->BindAbilityInputAction(InputConfigDataAsset, this , &ThisClass::Input_AbilityInputPressed, &ThisClass::Input_AbilityInputRelased);
}
...
void AWarriorHeroCharacter::Input_AbilityInputRelased(FGameplayTag InInputTag)
{
	WarriorAbilitySystemComponent->OnAbilityInputRelased(InInputTag);
}
