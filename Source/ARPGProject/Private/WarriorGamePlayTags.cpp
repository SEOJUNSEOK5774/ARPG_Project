...
namespace WarriorGamePlayTags
{
	...
	/**Input tags**/
	UE_DEFINE_GAMEPLAY_TAG(Input_Move, "InputTag.Move");

	UE_DEFINE_GAMEPLAY_TAG(Input_Look, "InputTag.Look");

	UE_DEFINE_GAMEPLAY_TAG(Input_Equip_Sword, "InputTag.Equip.Sword");

	UE_DEFINE_GAMEPLAY_TAG(Input_Unequip_Sword, "InputTag.Unequip.Sword");
